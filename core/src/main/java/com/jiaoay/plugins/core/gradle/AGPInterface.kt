...
inline fun <reified T : AndroidComponentsExtension<*, *, *>> Project.getAndroidComponents() =
    extensions.getByType(AndroidComponentsExtension::class.java) as T

inline fun <reified T : AndroidComponentsExtension<*, *, *>> Project.getAndroidComponentsOrNull() =
    try {
